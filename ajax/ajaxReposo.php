...
if (isset($_POST['id_usuario_rep_reg']) || isset($_POST['borrar_reg_rep']) || isset($_POST['borrar_foto_rep']) || isset($_POST['consignar_rep'] )) {
   ...
   // Eliminar Reposo 
    if (isset($_POST['borrar_reg_rep']) && isset($_POST['borrar_foto_rep'])) {
